...
Note: The average number of replacements per episode in the Cart-Pole environment is 42 where the average length of episodes is 129. dor more information read section 4.6 of the paper
